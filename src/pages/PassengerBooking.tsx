  ...
  return (
    <div className="h-screen flex flex-col bg-background-light dark:bg-background-dark">
      ...
      <main className="flex-1 flex overflow-hidden">
        <aside className="w-full lg:w-[480px] bg-surface-light dark:bg-surface-dark border-r border-slate-200 dark:border-slate-800 flex flex-col shadow-xl overflow-y-auto custom-scrollbar">
          {/* Search Section - Sticky */}
          <div className="p-6 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 bg-surface-light dark:bg-surface-dark">
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50 mb-6">Plan your journey</h1>
